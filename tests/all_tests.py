...
import imagepane_summary_tests
...
import specimen_summary_tests

from hunter import genotype_mp_hunter_tests

from api import all_api_tests
...
def master_suite():
    ...
    suites.append(imagepane_summary_tests.suite())
    ...
    suites.append(specimen_summary_tests.suite())
    
    suites.append(all_api_tests.master_suite())
